...
class ParameterPolicyStep6FContractTests(unittest.TestCase):
    ...
    def test_qualification_and_semantic_blockers_are_separate(self):
        ...
        self.assertIn("full_fp16", PARAMETER_POLICY_QUALIFICATION_BLOCKER_FIELDS)
        self.assertIn("full_bf16", PARAMETER_POLICY_QUALIFICATION_BLOCKER_FIELDS)
        self.assertIn("fp8_base", PARAMETER_POLICY_QUALIFICATION_BLOCKER_FIELDS)
        self.assertIn("fp8_base_unet", PARAMETER_POLICY_QUALIFICATION_BLOCKER_FIELDS)
