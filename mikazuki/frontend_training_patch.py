...
def patch_training_layout_js(content: str) -> str:
    ...
    content = _replace_once(
        ...
        '$=_=>{const Pc=__isComponentPreset(_);Pc&&(++__policyBootstrapGeneration.value,__policyBootstrapPending.value=!1);let m=Pc?clone(_):findChangedDataBySchema(_,n.value);a.value==null?a.value=clone(m):a.value=Object.assign({},a.value,m);Pc&&(__runtimeReady.value=!1,__runtimeBlockers.value=[],__refreshPreview()),console.log(a.value)}',
        "Component preset exact merge",
    )
